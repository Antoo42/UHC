package fr.anto42.emma.coreManager.scoreboard.tools;
...
public class VObjective
{
    ...
    public IScoreboardCriteria.EnumScoreboardHealthDisplay format = IScoreboardCriteria.EnumScoreboardHealthDisplay.INTEGER;
    public ObjectiveLocation location = ObjectiveLocation.SIDEBAR;
    public List<OfflinePlayer> receivers;
    public ConcurrentLinkedQueue<VScore> scores;
