...
public class SwitchScoreboard implements UHCScoreboard {
    private final SwitchModule switchModule;

    public SwitchScoreboard(SwitchModule switchModule) {
    ...
    public void updateScoreboard(ObjectiveSign objectiveSign, UUID uuid, String ip) {
        ...
        objectiveSign.setLine(7, "  §8┃ §fSwitch: §c" + TimeUtils.getEcartTimer(switchModule.getTimer(), switchModule.getL()));
